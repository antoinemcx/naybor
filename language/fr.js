...
module.exports = {
    ...
    BOT_COOLDOWN: (time, cmd) => `<:cooldown:793499078909755393> Il reste **${time}** seconde(s) avant de pouvoir réutiliser la commande \`${cmd}\``,
    ...
    TRACKADD: (track) => `<:musiccd:793466362256424960> \`${track.title}\` a bien été ajouté à la file d'attente (**${track.duration}**)`,
    ...
    RESUME_SUCCESS: `<:micro:793475053936443403> La musique actuelle a bien été relancée`,


    // VOLUME COMMAND
    VOLUME_ERR: `${emotes.x} Veuillez entrer un nombre valide entre **1** et **100**`,
    VOLUME_SUCCESS: (volume) => `<:volume:793480024287084544> Le volume a bien été fixé à \`${volume}%\``,
